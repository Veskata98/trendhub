...
import deleteTrend from '@/actions/trend-actions/deleteTrend';

export const DeleteTrendModal = () => {
    ...
    if (!isOpen || type !== 'deleteTrend' || !trendName) {
        return null;
    }
    ...
    return (
        ...
        rounded-lg shadow-sm flex flex-col items-center space-y-4"
            >
                ...
                <h4 className="font-semibold text-white !mt-0">Delete Trend</h4>

                <div className="flex flex-col items-center w-full space-y-8">
                    <p className="text-white text-center lg:text-left">
                        Are you sure you want to delete the trend &quot;<strong>{trendName}</strong>&quot;? This action
                        cannot be undone. To confirm, please type the trend name below.
                    </p>
                    <form
                        action={formAction}
                    ...
                    >
                        <div>
                            <Input
                                ...
                                name="title"
                                autoComplete="off"
                                placeholder="Type trend name to confirm"
                                required
                        ...
                        <SubmitButton disabled={trendName !== inputValue} />
                    </form>
                </div>
            </div>
        </div>
